            ...
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Text('📍 Ahmedabad',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w300),),
                    SizedBox(height: 8,),
                    Text('Good Morning',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold),),
                    Image.asset('assets/1.png'),
                    Center(child: Text('21°C',style: TextStyle(color: Colors.white,fontSize: 55,fontWeight: FontWeight.bold),),),
                    Center(child: Text('THUNDERSTORM',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.w500),),),
                    SizedBox(height: 5,),
                    Center(child: Text('Friday 16 * 09.41 am',style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.w300),),),
                    SizedBox(height: 30,),
                    Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 3,),
                                Text('5:30 am',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700),),
                              ],
                            )
                          ],
                        ),
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 3,),
                                Text('5:30 pm',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700),),
                              ],
                            )
                          ],
                        ),
